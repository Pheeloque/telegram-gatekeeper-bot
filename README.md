...
После выбора группы можно добавить канал в чёрный список по `@username`, числовому ID (например `4408329483`, как показывает Telegram) или просто переслав сообщение из этого канала. Посмотреть чёрный список или удалить канал можно аналогично.
